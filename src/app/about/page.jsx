...
const {scrollYProgress}=useScroll({container:containeref})

    return (
        <>
          <motion.div className="h-full " initial={{y:"-200vh"}} animate={{y:"0%"} } transition={{duration:1}}> 
         <div className="w-full h-full overflow-y-scroll lg:flex  " ref={containeref}>
            {/* text-container */}
          <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64  lg:w-2/3  xl:w-1/2">
            ...
            <p className="text-lg">Passionate digital creator with a flair for blending innovation and design. I craft visually stunning and user-centric digital experiences, driven by a commitment to excellence and a love for cutting-edge technology.</p>
             <span className="italic">Web developer with the Experience of 1 year</span>
        {/*signature svg */}
        <div className="self-end">
            ...
            animate={isskillrefInView ? {x:"0"} : {}}
             transition={{delay:0.2}}
              className="font-bold text-2xl">Skill</motion.h1>
{/* skilllist */}
<motion.div 
  initial={{x:"-300px"}} 
  animate={isskillrefInView ? {x:"0"} : {}}
...
className="flex gap-4 flex-wrap">
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">JavaScript</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">Html</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">CSS</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">React</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">NodeJs</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">Sql</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">MongoDb</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">C++</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">Git</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">Express</div>
    <div className="rounded p-2 text-sm bg-black text-white cursor:pointer hover:bg-white hover:text-black">Github</div>
                  ...
                  <motion.div 
                   ...
                   className="">
                     ...
                     <div className=" flex justify-between h-48 ">
                       {/* left */}
                       <div className="w-1/3">
                       <div className=" bg-white p-3 font-bold  ">Trainee Software Engineer</div>  
                       <div className="p-3 text-sm italic">Enterprise developer intergration department tibco</div>
                       <div className="p-3 text-red-400 text-sm font-semibold">2024-present</div>
                       <div className="bg-white p-1 text-sm  font-semibold w-fit">Fantech Labs</div>
                       </div>
                       {/* center */}
                       <div className=" w-1/6">
                         {/* line */}
                         <div className="w-1 h-full rounded relative bg-black">
                         {/* circle */}
